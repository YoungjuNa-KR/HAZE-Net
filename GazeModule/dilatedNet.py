...
class DilatedNet(nn.Module):
    def __init__(self):
        ...
        self.eyeStreamDConv = nn.Sequential(
            ...
            nn.Conv2d(64, 128, 3, 1, dilation=(1, 4)),
            nn.BatchNorm2d(128),
            nn.ReLU(inplace=True),

            nn.Conv2d(128, 128, 3, 1, dilation=(1, 3)),
            nn.BatchNorm2d(128),
            nn.ReLU(inplace=True),
        )
    ...
    def forward(self, le_c_list, re_c_list, face, head_batch_label):
        # Get face feature
        faceFeatureMap = self.faceStreamPretrainedConv(face)
        ...
        # Get left feature
        leftEyeFeature = self.eyeStreamConv(le_c_list)
        ...
        # Get Right feature
        rightEyeFeature = self.eyeStreamConv(re_c_list)
