...
parser = argparse.ArgumentParser(description='HAZE_Net')
...
parser.add_argument('--test_every', type=int, default=380,
...
parser.add_argument('--print_every', type=int, default=38,
...
parser.add_argument('--freeze', type=str, default="gaze",
                    help='get gaze loss')
parser.add_argument('--pre_gaze', type=str, default='.',
                    help='save output results')
parser.add_argument('--gaze_model_save_path', type=str, default='./gaze_model',
                    help='save output results')
